        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              >
                Verify User's payment
              </h1>
              <form action="verify_user.php" method="POST">
         
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">verify</span>
                  ...
                  <select   class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                   aria-label="Default select example>" name="verify" required>
                        <option >click to verify a user  </option>
